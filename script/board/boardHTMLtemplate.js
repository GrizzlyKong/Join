...
function generateTaskHTMLContent(taskId, categoryClass, category, title, description, dueDate, contactsHtml, priorityImage, progressPercent, completedSubtasks, totalSubtasks) {
  ...
  /**
 * Generates HTML markup for adding a new task to the board.
 * @returns {string} The HTML markup for adding a new task.
 */
  function addTaskHTML() {
    return /*html*/ `
      <form class="addTaskForm" onsubmit="return validateFormAddTask()">
        ...
        <div class="add-tasks-div center">
          <div class="add-tasks-left-side-div">
            <div class="title column">
              ...
              <input maxlength="22" id="title-todo" required type="text" placeholder="Enter a title" onkeydown="InputTitle(event)">
            </div>
          ...
          <div class="add-tasks-right-side-div">
            ...
            <div class="subtasks">
              ...
              <div class="subtaskInput">
                <input minlength="1" oninput="addSubtasks()" id="add-subtasks" type="text" placeholder="Add new subtask" onkeydown="correctSubtaskEnter(event)">
    ...
    let formHtml = /*html*/ `
      <form>
        ...
        <div class="save-edited-task-button">
          <button type="button" class="save-edited-Task pointer center" onclick="saveEditedTaskInfo('${taskId}'); return false;">
            <span>OK</span>
